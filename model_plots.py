...
for f in folders:
    ...
    init_counts = np.genfromtxt('init_counts.csv', dtype='int32', delimiter=',')
    prop_counts = np.genfromtxt('prop_counts.csv', dtype='int32', delimiter=',')
    bird_counts = np.genfromtxt('bird_counts.csv', dtype='int32', delimiter=',')
    sample_counts = np.genfromtxt('sample_counts.csv', dtype='int32',
                                  delimiter=',')
